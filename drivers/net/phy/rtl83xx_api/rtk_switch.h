...
#define RTK_SWITCH_HARD_RESET_DELAY_MS (1000)
#define RTK_SWITCH_SOFT_RESET_DELAY_MS (100)
...
#define RTK_API_LOCK() mutex_lock(&rtlglue_ctl_gbl->api_mutex)
#define RTK_API_UNLOCK() mutex_unlock(&rtlglue_ctl_gbl->api_mutex)
#endif
 ...
 *
 */
extern rtk_uint32 rtk_switch_isValidTrunkGrpId(rtk_uint32 grpId);
 ...
 *      None
 */
extern void rtk_switch_glueCtl_unregister(struct rtlglue_ctl *ctl);
 ...
 *      RT_ERR_FAILED       - Failed
 */
extern rtk_api_ret_t rtk_switch_glueCtl_register(struct rtlglue_ctl *ctl);
 ...
 *
 */
extern rtk_api_ret_t rtk_switch_hard_reset(void);
 ...
 *
 */
extern rtk_api_ret_t rtk_switch_soft_reset(void);
