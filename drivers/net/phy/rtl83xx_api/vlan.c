 ...
 *
 * $Revision: 79926 $
 * $Date: 2017-06-21 17:01:03 +0800 (週三, 21 六月 2017) $
 *
...
#define RTK_API_VLAN_DEFAULT_VLAN_ISOLATED

#ifdef RTK_API_VLAN_DEFAULT_VLAN_ISOLATED
	#define RTK_API_VLAN_DEFAULT_VID (0)
	#define RTK_API_VLAN_DEFAULT_MBR (1)
#else
	#define RTK_API_VLAN_DEFAULT_VID (1)
	#define RTK_API_VLAN_DEFAULT_MBR (RTK_PHY_PORTMASK_ALL)
#endif /* RTK_API_VLAN_DEFAULT_VLAN_ISOLATED */
...
static rtk_api_ret_t _rtk_vlan_init(void)
{
	...
	/* Set a default VLAN to 4K table for all ports */
	memset(&vlan4K, 0, sizeof(rtl8367c_user_vlan4kentry));
	vlan4K.vid = RTK_API_VLAN_DEFAULT_VID;
	vlan4K.mbr = RTK_API_VLAN_DEFAULT_MBR;
	vlan4K.untag = RTK_API_VLAN_DEFAULT_MBR;
	vlan4K.fid_msti = 0;
	...
	vlanMC.evid = RTK_API_VLAN_DEFAULT_VID;
	vlanMC.mbr = RTK_API_VLAN_DEFAULT_MBR;
	vlanMC.fid_msti = 0;
	...
	vlan_mbrCfgVid[0] = RTK_API_VLAN_DEFAULT_VID;
