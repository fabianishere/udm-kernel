...
/**
 *  @{
 * @file   al_mod_hal_serdes_avg_lane_regs.h
 *
...
struct al_mod_srd_1lane_regs {
	/* [0x0] 4 groups of interrupts */
	uint32_t int_ctrl_mem[64];
	/* [0x100] General configuration and status */
	struct al_mod_srd_1lane_gen gen;
	/* [0x200] */
	struct al_mod_srd_1lane_ctl ctl[2];
	/* [0x240] */
	struct al_mod_srd_1lane_fsm fsm[16];
	/* [0x340] Pcie spcific */
	struct al_mod_srd_1lane_pcie pcie;
	/* [0x360] 16nm SerDes macro */
	struct al_mod_srd_1lane_core core;
	/* [0x370] 16nm SerDes macro */
	struct al_mod_srd_1lane_eth eth;
	/* [0x380] */
	struct al_mod_srd_1lane_comma comma;
	/* [0x390] */
	struct al_mod_srd_1lane_sata sata;
	/* [0x3a0] */
	struct al_mod_srd_1lane_spico spico;
	/* [0x3c0] */
	uint32_t rsrvd_0[16];
};
