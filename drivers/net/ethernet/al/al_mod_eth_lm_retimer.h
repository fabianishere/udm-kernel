 ...
 * Supported retimers
 */
enum al_mod_eth_lm_retimer_type {
 ...
 * Retimer speed
 */
enum al_mod_eth_lm_retimer_speed {
	/** Invalid speed */
 ...
 */
enum al_mod_eth_lm_retimer_ch_dir {
	/** Invalid direction */
 ...
 * Retimer parameters
 */
struct al_mod_eth_lm_retimer;

struct al_mod_eth_lm_retimer_params {
	/** Retimer type */
	enum al_mod_eth_lm_retimer_type	type;

	/** Retimer I2C master */
	enum al_mod_i2c_master_t		i2c_master;
	/** Retimer I2C bus */
 ...
 */
struct al_mod_eth_lm_retimer_config_params {
	/** Direction */
	enum al_mod_eth_lm_retimer_ch_dir	dir;
...
struct al_mod_eth_lm_retimer {
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*config)(struct al_mod_eth_lm_retimer *handle,
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*reset)(struct al_mod_eth_lm_retimer *handle,
						unsigned int channel);
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*signal_detect)(struct al_mod_eth_lm_retimer *handle,
						unsigned int channel,
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*cdr_lock)(struct al_mod_eth_lm_retimer *handle,
						unsigned int channel,
						al_mod_bool *locked);
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*rx_eq_done)(struct al_mod_eth_lm_retimer *handle,
						unsigned int channel,
						al_mod_bool *done);
	 ...
	 *	0 on success, errno otherwise
	 */
	int				(*speed_detect)(struct al_mod_eth_lm_retimer *handle,
						unsigned int channel,
						enum al_mod_eth_lm_retimer_speed *speed);
 ...
 *	0 on success, errno otherwise
 */
int al_mod_eth_lm_retimer_handle_init(
