 ...
 */
enum al_mod_err_events_serdes_25g {
 ...
 */
enum al_mod_err_events_serdes_avg {
 ...
 */
enum al_mod_err_events_unit_adapter {
...
enum al_mod_err_events_axi_err_type {
 ...
 ** Init params
 ******************************************************************************/
struct al_mod_err_events_pbs_init_params {
	/** collection mode */
	enum al_mod_err_events_collect collect_mode;
};

struct al_mod_err_events_serdes_25g_init_params {
...
struct al_mod_err_events_serdes_avg_init_params {
	/** collection mode */
	enum al_mod_err_events_collect collect_mode;
...
struct al_mod_err_events_ua_init_params {
	/** Unit Adapter type */
 ...
 ******************************************************************************/
struct al_mod_err_events_pbs_data {
	struct al_mod_err_events_module module;

	struct al_mod_err_events_field fields[AL_ERR_EVENTS_PBS_MAX_ERRORS];
};

struct al_mod_err_events_serdes_25g_data {
	struct al_mod_err_events_module module;

	struct al_mod_err_events_field fields[AL_ERR_EVENTS_SERDES_MAX_ERRORS];
};

struct al_mod_err_events_serdes_avg_data {
	struct al_mod_err_events_module module;

	struct al_mod_err_events_field fields[AL_ERR_EVENTS_SERDES_AVG_MAX_ERRORS];

	struct al_mod_serdes_grp_obj	obj;
};

struct al_mod_err_events_unit_adapter_data {
	struct al_mod_err_events_module module;

	struct al_mod_err_events_field fields[AL_ERR_EVENTS_UNIT_ADAPTER_MAX_ERRORS];

	enum al_mod_unit_adapter_type type;

	struct al_mod_unit_adapter unit_adapter;

	struct al_mod_unit_adapter_err_attr axi_err;

	enum al_mod_err_events_axi_err_type axi_err_type;
