...
/**
 *  @{
 * @file   al_mod_hal_eth_mac_v4_regs.h
 *
 ...
 * Statistics counters
 */
struct al_mod_eth_mac_v4_stat_pcs {
	/*
 ...
 */
struct al_mod_eth_mac_v4_gen_v4 {
 ...
 */
struct al_mod_eth_mac_v4_gen_v4_sr {
	/* [0x0] */
	uint32_t rsrvd_0;
...
struct al_mod_eth_mac_v4_regs {
	/* [0x0] Ethernet MPS Version register */
	struct al_mod_eth_mac_v4_gen gen;
	/* [0x100] 4 groups of interrupts */
	uint32_t int_ctrl_mem[64];
	/* [0x200] */
	struct al_mod_eth_mac_v4_mtip mtip;
	/* [0x300] Statistics counters */
	struct al_mod_eth_mac_v4_stat_pcs stat_pcs;
	/* [0x400] */
	uint32_t rsrvd_0[64];
	/* [0x500] General configuration for the MAC V4 integration */
	struct al_mod_eth_mac_v4_gen_v4 gen_v4;
	/* [0x600] Statistic counters */
	struct al_mod_eth_mac_v4_stat stat;
	/* [0x700] Shared registers status brought out to channels */
	struct al_mod_eth_mac_v4_gen_v4_sr gen_v4_sr;
	/* [0x800] */
