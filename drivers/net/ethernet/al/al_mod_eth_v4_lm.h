 ...
 */
struct al_mod_eth_v4_lm_lane_retimer_params {
 ...
 * Lane parameters
 */
struct al_mod_eth_v4_lm_lane_params {
	/**
	 * SerDes lane index
	 *
	...
	/** RX Retimer */
	struct al_mod_eth_v4_lm_lane_retimer_params		rx_retimer;
	/** TX Retimer */
	struct al_mod_eth_v4_lm_lane_retimer_params		tx_retimer;
	 ...
	 * other port.
	 */
	al_mod_bool				sfp_presence_exists;
	/** SFP presence GPIO */
 ...
 */
enum al_mod_eth_v4_lm_time_units {
	/** Milliseconds */
 ...
 */
struct al_mod_eth_v4_lm_params {
	/** Ethernet device ID */
	unsigned int			dev_id;
	...
	union {
		...
		struct al_mod_eth_mac_obj		*mac_objs[AL_ETH_V4_LM_MAC_MAX];
	};

	/** SerDes lanes */
	struct al_mod_eth_v4_lm_lane_params	lanes[AL_ETH_V4_LM_LANE_MAX];
	unsigned int			lanes_num;

	/** Retimers */
	struct al_mod_eth_lm_retimer_params retimers[AL_ETH_V4_LM_RETIMER_MAX];
	...
	int				(*gpio_get)(void *gpio_context,
						unsigned int gpio, al_mod_bool *val);
	 ...
	 */
	enum al_mod_eth_v4_lm_time_units	time_units;
...
struct al_mod_eth_v4_lm_detected_mode {
	/** Is mode detected? */
...
struct al_mod_eth_v4_lm_status {
	...
	al_mod_bool				link_local_fault;
	/** Link status - Remote fault */
	al_mod_bool				link_remote_fault;
};
...
struct al_mod_eth_v4_lm_lane_retimer {
	/** Retimer index (referring to retimers in LM handle) */
	unsigned int			idx;
	/** Retimer channel */
	unsigned int			channel;
...
struct al_mod_eth_v4_lm_lane {
	/** SerDes object */
	struct al_mod_serdes_grp_obj	*serdes_obj;

	/** RX Retimer */
	struct al_mod_eth_v4_lm_lane_retimer		rx_retimer;
	/** TX Retimer */
	struct al_mod_eth_v4_lm_lane_retimer		tx_retimer;
...
struct al_mod_eth_v4_lm {
	...
	/** SerDes lanes */
	struct al_mod_eth_v4_lm_lane	lanes[AL_ETH_V4_LM_LANE_MAX];
	unsigned int			lanes_num;

	/** Retimers */
	struct al_mod_eth_lm_retimer	retimers[AL_ETH_V4_LM_RETIMER_MAX];
	unsigned int			retimers_num;
	...
	al_mod_bool				state_return;
	/** Internal state machine - state start time set */
	al_mod_bool				state_start_time_set;
