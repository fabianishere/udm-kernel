 ...
 */
struct al_mod_ec_crypto_perf_cntr {
	/*
	 * [0x0]
	 * Reset: 0x0         Access: RW
	 */
 ...
 * tid_default_entry
 */
struct al_mod_ec_crypto_tx_tid {
	/*
 ...
 */
struct al_mod_ec_tmi_fwd_table {
	/* [0x0] Table access address */
	uint32_t addr;
	/* [0x4] */
	uint32_t fields;
 ...
 */
struct al_mod_ec_rfw_v4_udma_select {
	/*
 ...
 * 3-4 : Tx instances
 */
struct al_mod_ec_outstanding_gen {
 ...
 */
struct al_mod_ec_rfw_prot_index {
 ...
 * udp len insertion
 */
struct al_mod_ec_udp_len_insertion {
 ...
 */
struct al_mod_ec_crdt_os2sr_wr {
	/* [0x0] */
	uint32_t req;
	/* [0x4] */
	uint32_t res;
...
struct al_mod_ec_regs {
	 ...
	 * map)
	 */
	struct al_mod_ec_crypto_perf_cntr crypto_perf_cntr[2];
	/* [0x2940] */
	uint32_t rsrvd_4[48];
	/* [0x2a00] tid_default_entry */
	struct al_mod_ec_crypto_tx_tid crypto_tx_tid[8];
	/* [0x2a20] */
	uint32_t rsrvd_5[16];
	/* [0x2a60] Remap table of protocol numbers. Map 64 possible protocol numbers to 4. */
	struct al_mod_ec_pn_remap pn_remap;
	/* [0x2a80] TMI Forwarding Table */
	struct al_mod_ec_tmi_fwd_table tmi_fwd_table;
	/* [0x2b00] Rx Forwarding engine, udma selection, port mapping */
	struct al_mod_ec_rfw_v4_udma_select rfw_v4_udma_select[64];
	/* [0x2c00] Rx Forwarding engine V4 */
	struct al_mod_ec_rfw_v4 rfw_v4;
	/* [0x2c10] */
	uint32_t rsrvd_6[28];
	/* [0x2c80] crc parameters */
	struct al_mod_ec_crc crc[4];
	/* [0x3080] crc extended parameters table */
	struct al_mod_ec_crc_extended crc_extended;
	/*
	 * [0x30dc] Outstanding table
	 * 0-2 : Rx instances
	 * 3-4 : Tx instances
	 */
	struct al_mod_ec_outstanding_gen outstanding_gen;
	/* [0x30e0] outstanding tableec */
	struct al_mod_ec_outstanding outstanding[4];
	/* [0x3100] RFF configuration */
	struct al_mod_ec_rff rff;
	/* [0x3108] */
	uint32_t rsrvd_7[62];
	/* [0x3200] rfw protocol_index selection table */
	struct al_mod_ec_rfw_prot_index rfw_prot_index[64];
	/* [0x3600] */
	uint32_t rsrvd_8[268];
	/* [0x3a30] udp len offset table */
	struct al_mod_ec_udp_len udp_len[16];
	/* [0x3a70] udp len insertion */
	struct al_mod_ec_udp_len_insertion udp_len_insertion;
	/* [0x3a84] */
	uint32_t rsrvd_9[127];
	/* [0x3c80] TMI V4 */
	struct al_mod_ec_tmi_v4 tmi_v4;
	/* [0x3c84] */
	uint32_t rsrvd_10[31];
	/* [0x3d00] csd db write credit base */
	struct al_mod_ec_crdt_os2sr_wr crdt_os2sr_wr;
	/* [0x3d08] */
	uint32_t rsrvd_11[94];
	/* [0x3e80] */
	struct al_mod_ec_spare spare[16];
	/* [0x3f00] */
