...
/**
 *  @{
 * @file   al_mod_hal_eth_rmp_regs.h
 *
 ...
 */
struct al_mod_ec_rmp_stat_hdr_input_fifo {
	/*
...
struct al_mod_ec_rmp_regs {
	 ...
	 * 16-31 - Registers for tables of parser 2
	 */
	struct al_mod_ec_rmp_epe_h epe_h[32];
	/* [0x1d0] */
	uint32_t rsrvd_3[12];
	/* [0x200] Statistic counters */
	struct al_mod_ec_rmp_stat stat[8];
	/* [0x240] Hdr input fifo statistic counters */
	struct al_mod_ec_rmp_stat_hdr_input_fifo stat_hdr_input_fifo[4];
	/* [0x2b0] */
	uint32_t rsrvd_4[20];
	/* [0x300] Rx Multi Parser */
	struct al_mod_ec_rmp_rmp rmp;
	/* [0x340] */
	uint32_t rsrvd_5[48];
	/* [0x400] */
	uint32_t int_ctrl_mem[64];
	/* [0x500] */
	struct al_mod_ec_rmp_spare spare[4];
	/* [0x520] */
