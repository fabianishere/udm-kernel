...
static int al_mod_eth_i2c_data_write(void *context, uint8_t bus_id, uint8_t i2c_addr, uint8_t reg_addr,
				 uint8_t *val, size_t len, al_mod_bool seq)
{
	struct i2c_adapter *i2c_adapter;
	struct al_mod_eth_adapter *adapter = context;
...
static int al_mod_eth_i2c_byte_write(void *context, uint8_t bus_id, uint8_t i2c_addr, uint8_t reg_addr,
				 uint8_t val)
{
...
#if defined(CONFIG_ARCH_ALPINE) && LINUX_VERSION_CODE >= KERNEL_VERSION(4, 3, 0)
...
#endif /* defined(CONFIG_ARCH_ALPINE) && LINUX_VERSION_CODE >= KERNEL_VERSION(4, 3, 0) */
...
/* TODO: reserved memory region is not used, backport it properly later */
...
{
#ifdef CONFIG_ARCH_ALPINE
/* TODO: Live update with reserved memory region is not used, backport it properly when necessary */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 3, 0)
