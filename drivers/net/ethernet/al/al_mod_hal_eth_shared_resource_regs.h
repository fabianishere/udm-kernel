...
/**
 *  @{
 * @file   al_mod_hal_eth_shared_resource_regs.h
 *
 ...
 */
struct al_mod_eth_shared_resource_gen {
 ...
 */
struct al_mod_eth_shared_resource_spare {
	/*
 ...
 */
struct al_mod_eth_shared_resource_irqs {
	/*
 ...
 */
struct al_mod_eth_shared_resource_rxf {
	/* [0x0] RXF data fifo 1 */
 ...
 */
struct al_mod_eth_shared_resource_rxf_port_mapping {
	/* [0x0] */
 ...
 * AXI Slave
 */
struct al_mod_eth_shared_resource_axi_slave {
...
struct al_mod_eth_shared_resource_rfw_pipe_ctl {
	/* [0x0] */
 ...
 */
struct al_mod_eth_shared_resource_rfw_table_ctl {
	/*
	 * [0x0]
	 * Reset: 0x0         Access: RW
	 */
...
struct al_mod_eth_shared_resource_rfw_reg_crdt_base {
	/* [0x0] */
	uint32_t sw_reset;
	/* [0x4] */
...
struct al_mod_eth_shared_resource_rxf_maping {
	/* [0x0] */
...
struct al_mod_eth_shared_resource_reg {
	/* [0x0] */
	uint32_t vf_tcam;
	/* [0x4] */
 ...
 * TCAM 11 - CSP
 */
struct al_mod_eth_shared_resource_reg_tcam_core_ctl {
	/* [0x0] */
	uint32_t bist;
	/* [0x4] */
...
struct al_mod_eth_shared_resource_axs_dwrr_arb_ctrl {
	/* [0x0] */
	uint32_t arb_config;
	/* [0x4] */
	uint32_t cred_level;
...
struct al_mod_eth_shared_resource_regs {
	...
	struct al_mod_eth_shared_resource_gen gen;
	/* [0x280] Ethernet Shared resource regfile spare bits */
	struct al_mod_eth_shared_resource_spare spare[4];
	/* [0x2a0] this is to have spare int triggers inisde INT controller for ECO */
	struct al_mod_eth_shared_resource_irqs irqs;
	/* [0x2a4] */
	uint32_t rsrvd_0[23];
	/* [0x300] RX FIFO, per EC FIFO allocation */
	struct al_mod_eth_shared_resource_rxf rxf[4];
	/* [0x340] */
	uint32_t rsrvd_1[20];
	/* [0x390] what EC indication to put in the AXS info */
	struct al_mod_eth_shared_resource_rxf_port_mapping rxf_port_mapping;
	/* [0x394] */
	uint32_t rsrvd_2[27];
	/* [0x400] AXI Slave */
	struct al_mod_eth_shared_resource_axi_slave axi_slave;
	/* [0x500] */
	struct al_mod_eth_shared_resource_rfw_pipe_ctl rfw_pipe_ctl;
	/* [0x510] */
	uint32_t rsrvd_3[4];
	/*
	 ...
	 */
	struct al_mod_eth_shared_resource_rfw_table_ctl rfw_table_ctl[19];
	/* [0x8b0] */
	struct al_mod_eth_shared_resource_rfw_reg_crdt_base rfw_reg_crdt_base;
	/* [0x8d4] */
	uint32_t rsrvd_4[11];
	/* [0x900] */
	struct al_mod_eth_shared_resource_rxf_maping rxf_maping;
	/* [0x920] */
	struct al_mod_eth_shared_resource_reg reg;
	/* [0x938] */
	uint32_t rsrvd_5[18];
	/*
	 * [0x980] TCAM (0-7) - VF
	 ...
	 * TCAM 11 - CSP
	 */
	struct al_mod_eth_shared_resource_reg_tcam_core_ctl reg_tcam_core_ctl[12];
	/* [0x9e0] */
	uint32_t rsrvd_6[8];
	/* [0xa00] */
	struct al_mod_eth_shared_resource_axs_dwrr_arb_ctrl axs_dwrr_arb_ctrl;
	/* [0xa18] */
