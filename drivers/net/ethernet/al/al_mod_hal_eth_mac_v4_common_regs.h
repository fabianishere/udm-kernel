...
/**
 *  @{
 * @file   al_mod_hal_eth_mac_v4_common_regs.h
 *
 ...
 */
struct al_mod_eth_mac_v4_common_gen_v4 {
 ...
 */
struct al_mod_eth_mac_v4_common_gbl {
 ...
 */
struct al_mod_eth_mac_v4_common_mtip {
	/* [0x0] */
 ...
 * Statistics counters
 */
struct al_mod_eth_mac_v4_common_stat_pcs {
	/*
...
struct al_mod_eth_mac_v4_common_regs {
	/* [0x0] Ethernet MPS Version register */
	struct al_mod_eth_mac_v4_common_gen_v4 gen_v4;
	/* [0x100] Global configuration for the MPS */
	struct al_mod_eth_mac_v4_common_gbl gbl;
	/* [0x200] MTIP Indirect register access to PCS and AN LT blocks */
	struct al_mod_eth_mac_v4_common_mtip mtip;
	/* [0x300] Statistics counters */
	struct al_mod_eth_mac_v4_common_stat_pcs stat_pcs;
	/* [0x400] */
