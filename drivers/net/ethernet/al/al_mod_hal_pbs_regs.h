...
struct al_mod_pbs_spim_preload {
...
struct al_mod_pbs_chip_capabilities {
	/*
...
struct al_mod_pbs_low_latency_sram_remap {
	/* [0x0] PBS MEM Remap */
	uint32_t bar1_orig;
	/* [0x4] PBS MEM Remap */
	uint32_t bar1_remap;
...
struct al_mod_pbs_target_id_enforcement_v2 {
...
struct al_mod_pbs_target_id_enforcement_v3 {
	/* [0x0] target enforcement */
	uint32_t cpu_high;
...
struct al_mod_pbs_spi_debug_pasw {
	/* [0x0] TZPASW */
...
struct al_mod_pbs_spi_debug_pasw_enable {
	/* [0x0] */
...
struct al_mod_pbs_regs {
	/* [0x0] */
	struct al_mod_pbs_unit unit;
	uint32_t iofic_base;						/* [0x300] */
	uint32_t rsrvd_0[63];
	struct al_mod_pbs_target_id_enforcement_v2 target_id_enforcement_v2;	/* [0x400] */
	/*
	 * [0x500] INTCA:
	...
	uint32_t rsrvd_1[63];
	/* [0x600] */
	struct al_mod_pbs_qspi qspi;
	/* [0x650] */
	struct al_mod_pbs_spim_preload spim_preload;
	/* [0x670] */
	uint32_t rsrvd_2[36];
	/* [0x700] */
	struct al_mod_pbs_chip_capabilities chip_capabilities;
	/* [0x740] */
	uint32_t rsrvd_3[560];
	/* [0x1000] */
	struct al_mod_pbs_bar_config bar_config;
	/* [0x1200] */
	struct al_mod_pbs_low_latency_sram_remap low_latency_sram_remap;
	/* [0x1250] */
	uint32_t rsrvd_4[44];
	/* [0x1300] */
	struct al_mod_pbs_target_id_enforcement_v3 target_id_enforcement;
	/* [0x1500] */
	struct al_mod_pbs_spi_debug_pasw spi_debug_pasw[16];
	/* [0x1580] */
	uint32_t rsrvd_5[32];
	/* [0x1600] */
	struct al_mod_pbs_spi_debug_pasw_enable spi_debug_pasw_enable;
};
