...
#define AL_DMA_MAX_CHANNELS_V1_V2	4
#define AL_DMA_MAX_CHANNELS_V3		16
#define AL_DMA_MAX_CHANNELS_MAX		16
...
struct al_dma_device {
	...
	struct msix_entry		msix_entries[AL_DMA_MAX_CHANNELS_MAX];
	struct al_dma_irq		irq_tbl[AL_DMA_MAX_CHANNELS_MAX];
	struct al_dma_chan		*channels[AL_DMA_MAX_CHANNELS_MAX];
	int				max_channels;
