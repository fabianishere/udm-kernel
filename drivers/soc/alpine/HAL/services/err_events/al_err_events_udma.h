 ...
 ** Init params
 ******************************************************************************/
struct al_err_events_udma_init_params {
 ...
 ******************************************************************************/
struct al_err_events_udma_data {
	struct al_err_events_module module;

	struct al_err_events_field fields[AL_ERR_EVENTS_UDMA_MAX_ERRORS];
