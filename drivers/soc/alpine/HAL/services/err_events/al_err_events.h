...
struct al_err_events_handle;
struct al_err_events_module;
struct al_err_events_field;

typedef int (*al_err_events_print_cb)(const char *format, ...);
typedef void (*al_err_events_error_cb)(struct al_err_events_field *);
...
struct al_err_events_field {
	...
	/** Field severity */
	enum al_err_events_err_sev sev;
	 ...
	 * @return none
	 */
	void (*print)(struct al_err_events_field *, al_bool);
	 ...
	 * @return none
	 */
	void (*collect)(struct al_err_events_field *, uint32_t);
	 ...
	 * @return none
	 */
	void (*mask)(struct al_err_events_field *);

	/* Pointer to the field's parent err_events object */
	struct al_err_events_module *parent_module;
};
...
struct al_err_events_module {
	...
	struct al_err_events_module *next_comp;
};

struct al_err_events_handle_init_params {
	...
	al_err_events_error_cb error_cb;
...
struct al_err_events_handle {
	...
	/* List of components */
	struct al_err_events_module *first_comp;
};
