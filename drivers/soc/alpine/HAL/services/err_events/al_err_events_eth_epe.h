 ...
 ** Init params
 ******************************************************************************/
struct al_err_events_eth_epe_init_params {
	/** EPE handle */
	struct al_eth_epe_handle_init_params *handle_params;
 ...
 ******************************************************************************/
struct al_err_events_eth_epe_data {
	struct al_err_events_module module;

	struct al_err_events_field fields[AL_ERR_EVENTS_ETH_EPE_MAX_ERRORS];

	/** EPE handle */
	struct al_eth_epe_handle handle;
