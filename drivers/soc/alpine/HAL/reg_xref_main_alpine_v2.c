...
int main()
{
	...
	reg_print_offsets_serdes_25g((void *)AL_SERDES_BASE(4));
	reg_print_offsets_nb_service((void *)AL_NB_SERVICE_BASE);
	reg_print_offsets_ccu((void *)AL_NB_CCI_BASE);
	...
	reg_print_offsets_eth0_udma1((void *)AL_ETH_UDMA_BASE(0, 1));
	reg_print_offsets_eth0_udma2((void *)AL_ETH_UDMA_BASE(0, 2));
	reg_print_offsets_eth0_udma3((void *)AL_ETH_UDMA_BASE(0, 3));
	...
	reg_print_offsets_eth2_udma0((void *)AL_ETH_UDMA_BASE(2, 1));
	reg_print_offsets_eth2_udma0((void *)AL_ETH_UDMA_BASE(2, 2));
	reg_print_offsets_eth2_udma0((void *)AL_ETH_UDMA_BASE(2, 3));
	...
	reg_print_offsets_ssm0_udma1((void *)AL_SSM_CRYPTO_UDMA_BASE(1));
	...
	reg_print_offsets_ssm1_udma1((void *)AL_SSM_RAID_UDMA_BASE(1));
