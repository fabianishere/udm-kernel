...
export INCLUDES="$INCLUDES -I./platform/alpine_v1/include/"
...
cpp drivers/ddr/al_hal_ddr_ctrl_regs_alpine_v1.h $INCLUDES | sed "s/^#.*//g" > $OUTPUT_DIR/ddr_ctrl_regs.h
./reg_xref.pl $OUTPUT_DIR/ddr_ctrl_regs.h al_ddr_ctrl_regs_alpine_v1 ddr_ctrl > $OUTPUT_DIR/reg_print_offsets_ddr_ctrl.c
export SOURCES="$SOURCES $OUTPUT_DIR/reg_print_offsets_ddr_ctrl.c"

cpp drivers/ddr/al_hal_ddr_phy_regs_alpine_v1.h $INCLUDES | sed "s/^#.*//g" > $OUTPUT_DIR/ddr_phy_regs.h
./reg_xref.pl $OUTPUT_DIR/ddr_phy_regs.h al_dwc_ddrphy_top_regs_alpine_v1 ddr_phy > $OUTPUT_DIR/reg_print_offsets_ddr_phy.c
...
./reg_xref.pl $OUTPUT_DIR/pcie_regs.h al_pcie_rev2_regs pcie0 > $OUTPUT_DIR/reg_print_offsets_pcie0.c
...
cp reg_xref_main_alpine_v1.c $OUTPUT_DIR/
gcc -o $OUTPUT_DIR/reg_print $OUTPUT_DIR/reg_xref_main_alpine_v1.c $SOURCES $INCLUDES -Wno-implicit-function-declaration
$OUTPUT_DIR/reg_print | sort -k 3 > reg_xref_alpine_v1.txt
rm -rf $OUTPUT_DIR/
