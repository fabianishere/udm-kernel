...
#ifdef CONFIG_SWCONFIG_UBNT_EXT
	SWITCH_ATTR_OP_VALUE_MIB,
	SWITCH_ATTR_OP_SVLAN,
#endif /* CONFIG_SWCONFIG_UBNT_EXT */
...
enum {
	...
	SWITCH_CMD_SET_VLAN,
#ifdef CONFIG_SWCONFIG_UBNT_EXT
	SWITCH_CMD_LIST_SVLAN,
	SWITCH_CMD_GET_SVLAN,
	SWITCH_CMD_SET_SVLAN
#endif /* CONFIG_SWCONFIG_UBNT_EXT */
};
...
#ifdef CONFIG_SWCONFIG_UBNT_EXT
/* mib nested attributes */
enum {
	SWITCH_MIB_UNSPEC,
#define COUNTER(_enum, _name) SWITCH_MIB_##_enum,
	SWITCH_MIB_COUNTERS(COUNTER)
#undef COUNTER
	SWITCH_MIB_TIMESTAMP,
	SWITCH_MIB_ATTR_MAX
};
#endif /* CONFIG_SWCONFIG_UBNT_EXT */
