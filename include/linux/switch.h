...
#ifdef CONFIG_SWCONFIG_UBNT_EXT
	/* ubnt extention operations */
	struct uext_ops ubnt_ext_ops;

	/* SVLAN support */
	struct switch_attrlist attr_svlan;
#endif
};
...
struct switch_dev {
	...
	char buf[128];
#ifdef CONFIG_SWCONFIG_UBNT_EXT
	/* ubnt extension structure */
	struct uext ubnt_ext;
	/* mib structure */
	struct switch_port_mib mibbuf;

	/* SVLAN def */
	unsigned long def_svlan;
